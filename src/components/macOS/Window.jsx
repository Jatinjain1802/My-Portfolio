        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    >
                        {/* Window Header */}
                        <div className="window-header h-10 bg-[#e8e8e8] dark:bg-[#2d2d2d] border-b border-gray-300 dark:border-black/50 flex items-center justify-between px-4 cursor-default w-full shrink-0" onDoubleClick={onMaximize}>
